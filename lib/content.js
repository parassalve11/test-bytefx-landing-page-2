...
export const hero = {
  ...
  slides: [
    ...
    },
    {
      ...
      art: {
        src: '/assets/hero/hero-gold-markets.webp',
        width: 1536,
        height: 1024,
        focus: { x: 0.75, y: 0.5 },
        mobileFocus: { x: 0.74, y: 0.5 },
      },
...
export const bento = {
  markets: {
    ...
    alt: 'Glass currency tokens and precious-metal bars with lime edges and soft reflections',
    categories: [
      { id: 'forex', label: 'Forex', symbol: 'FX', title: 'A world of currencies.', description: 'Explore currency pairs and the connections between global economies.', tags: ['Currency pairs', 'Global economies'] },
      { id: 'indices', label: 'Indices', symbol: 'IX', title: 'See the bigger picture.', description: 'Explore market benchmarks that bring groups of companies into one view.', tags: ['Market benchmarks', 'Broader trends'] },
      { id: 'crypto', label: 'Crypto', symbol: '₿', title: 'Discover digital markets.', description: 'Explore digital assets and a different side of the global market.', tags: ['Digital assets', 'New perspectives'] },
      { id: 'commodities', label: 'Commodities', symbol: 'Au', title: 'Real-world essentials.', description: 'Explore metals, energy and the resources that keep the world moving.', tags: ['Precious metals', 'Energy markets'] },
      { id: 'shares', label: 'Shares', symbol: 'EQ', title: 'Follow the companies you know.', description: 'Explore companies, industries and the ideas shaping business around the world.', tags: ['Global companies', 'Industry trends'] },
    ],
  },
  platforms: {
    ...
    image: '/assets/platforms/trade-everywhere.webp',
    alt: 'A trader checking the markets on a phone, ringed by neon light trails and floating Android, Windows and web platform tiles',
