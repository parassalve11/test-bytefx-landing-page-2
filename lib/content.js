...
=======
    image: '/assets/generated/market-tokens.png',
    alt: 'Glass currency tokens and precious-metal bars with lime edges and soft reflections',
    /* The icons that revolve around the artwork, in orbit order.
       Sources and licences: public/assets/markets/sources.json */
    categories: [
      { id: 'forex', label: 'Forex', icon: '/assets/markets/forex.webp' },
      { id: 'indices', label: 'Indices', icon: '/assets/markets/indices.webp' },
      { id: 'crypto', label: 'Crypto', icon: '/assets/markets/crypto.webp' },
      { id: 'commodities', label: 'Commodities', icon: '/assets/markets/commodities.webp' },
      { id: 'shares', label: 'Shares', icon: '/assets/markets/shares.webp' },
    ],
...
=======
    ...
    title: 'ByteFX platforms built for you',
    body:
